...
#define  LOGI(...)  __android_log_print(ANDROID_LOG_INFO,"aaaatime",__VA_ARGS__)
#ifndef FZ_ENABLE_MOBI
class ZLLogger {
...
public:
	...
	void println(const std::string &className,const char* file,const int line, const std::string &message) const;
